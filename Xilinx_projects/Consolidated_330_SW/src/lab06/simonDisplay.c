...
//Return which region is correlated with that x and y value set
int8_t simonDisplay_computeRegionNumber(int16_t x, int16_t y){
	  if (x < 0 || y < 0)		//if either x or y is negative
	    return -1;				//the region does not exist
	  if (x < SIMON_DISPLAY_HALF_WIDTH){  		//we are in the left half
		  if (y < SIMON_DISPLAY_HALF_HEIGHT)		//we are on top
			  return SIMON_DISPLAY_REGION_0;		//top left
		  else										//we are on bottom
...
void simonDisplay_drawButton(uint8_t regionNumber){
	...
	switch(regionNumber) {					//button 0-4
	case SIMON_DISPLAY_BUTTON_2:			//BOTTOM LEFT
		display_fillRect(SIMON_DISPLAY_FOURTH_WIDTH	-	SIMON_DISPLAY_BUTTON_WIDTH_HALF,	//top left of button
				SIMON_DISPLAY_THREE_FOURTH_HEIGHT	-	SIMON_DISPLAY_BUTTON_WIDTH_HALF, 	//top left of button
				SIMON_DISPLAY_BUTTON_WIDTH, 		//size of button
				SIMON_DISPLAY_BUTTON_HEIGHT, 		//size of button
				DISPLAY_BLUE);				//BUTTON COLOR
		break;
	case SIMON_DISPLAY_BUTTON_0:			//TOP LEFT
		display_fillRect(SIMON_DISPLAY_FOURTH_WIDTH	-	SIMON_DISPLAY_BUTTON_WIDTH_HALF,	//top left of button
				SIMON_DISPLAY_FOURTH_HEIGHT			-	SIMON_DISPLAY_BUTTON_WIDTH_HALF,	//top left of button
				SIMON_DISPLAY_BUTTON_WIDTH, 		//size of button
				SIMON_DISPLAY_BUTTON_HEIGHT, 		//size of button
				DISPLAY_RED);				//BUTTON COLOR
		break;
	case SIMON_DISPLAY_BUTTON_1:			//TOP RIGHT
		display_fillRect(SIMON_DISPLAY_THREE_FOURTH_WIDTH	-	SIMON_DISPLAY_BUTTON_WIDTH_HALF,	//top left of button
				SIMON_DISPLAY_FOURTH_HEIGHT					-	SIMON_DISPLAY_BUTTON_WIDTH_HALF,	//top left of button
				SIMON_DISPLAY_BUTTON_WIDTH, 		//size of button
				SIMON_DISPLAY_BUTTON_HEIGHT, 		//size of button
				DISPLAY_YELLOW);			//BUTTON COLOR
		break;
	case SIMON_DISPLAY_BUTTON_3:			//BOTTOM RIGHT
		display_fillRect(SIMON_DISPLAY_THREE_FOURTH_WIDTH	-	SIMON_DISPLAY_BUTTON_WIDTH_HALF,	//top left of button
				SIMON_DISPLAY_THREE_FOURTH_HEIGHT			-	SIMON_DISPLAY_BUTTON_WIDTH_HALF,	//top left of button
				SIMON_DISPLAY_BUTTON_WIDTH, 		//size of button
				SIMON_DISPLAY_BUTTON_HEIGHT, 		//size of button
				DISPLAY_GREEN);				//BUTTON COLOR
		break;
	default:								//THis is an error
		printf("We can't draw a button! Trying to draw button %d\n\r", regionNumber);	//print the error
		break;
	}
}
...
void simonDisplay_drawAllButtons(){
	simonDisplay_drawButton(SIMON_DISPLAY_BUTTON_0);	//draw button 0
	simonDisplay_drawButton(SIMON_DISPLAY_BUTTON_1);	//draw button 1
	simonDisplay_drawButton(SIMON_DISPLAY_BUTTON_2);	//draw button 2
	simonDisplay_drawButton(SIMON_DISPLAY_BUTTON_3);	//draw button 3
}
...
void simonDisplay_drawSquare(uint8_t regionNo, bool erase){
		...
		// API: fillRect(x, y, width, height)
		switch(regionNo) {					//button 0-4
		case SIMON_DISPLAY_BUTTON_2:			//BOTTOM LEFT
			display_fillRect(0,					//Far left
					SIMON_DISPLAY_HALF_HEIGHT, 	//Halfway down
					SIMON_DISPLAY_HALF_WIDTH, 	//Half the screen
					SIMON_DISPLAY_HALF_HEIGHT, 	//Half the screen
					erase ? DISPLAY_BLACK : DISPLAY_BLUE);	//either black or BUTTON COLOR depending on erase
			break;
		case SIMON_DISPLAY_BUTTON_0:			//TOP LEFT
			display_fillRect(0,					//Top
					0,							//Far left
					SIMON_DISPLAY_HALF_WIDTH, 	//Half the screen
					SIMON_DISPLAY_HALF_HEIGHT, 	//Half the screen
					erase ? DISPLAY_BLACK : DISPLAY_RED);	//either black or BUTTON COLOR depending on erase
			break;
		case SIMON_DISPLAY_BUTTON_1:			//TOP RIGHT
			display_fillRect(SIMON_DISPLAY_HALF_WIDTH,	//Middle
					0,									//Top
					SIMON_DISPLAY_HALF_WIDTH, 	//Half the screen
					SIMON_DISPLAY_HALF_HEIGHT, 	//Half the screen
					erase ? DISPLAY_BLACK : DISPLAY_YELLOW);	//either black or BUTTON COLOR depending on erase
			break;
		case SIMON_DISPLAY_BUTTON_3:			//BOTTOM RIGHT
			display_fillRect(SIMON_DISPLAY_HALF_WIDTH,	//Middle
					SIMON_DISPLAY_HALF_HEIGHT,			//Middle
					SIMON_DISPLAY_HALF_WIDTH, 	//Half the screen
					SIMON_DISPLAY_HALF_HEIGHT, 	//Half the screen
					erase ? DISPLAY_BLACK : DISPLAY_GREEN);	//either black or BUTTON COLOR depending on erase
			break;
		default:								//THis is an error
			printf("We can't draw a button! Trying to draw button %d\n\r", regionNo);	//print the error
			break;
		}
}
